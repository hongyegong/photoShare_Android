...
//        return list;
    ...
    *
    ...
    public String upload(byte [] body, String suffix, String path, boolean isTongbu){
        ...
        String str = SystemPropertyUtil.get("BaseDir");
        if (StringUtils.isBlank(str)){
            throw new BusinessException("未配置根路径");
        }
        ...
        if (path.startsWith("logo")){
            ...
            finalPath = path + File.separator + year + File.separator + month + File.separator;
        ...
        if (path.startsWith("logo")){
        	returnStr = "/uploadphoto/" + path;
        } else {
        	returnStr = "/uploadphoto/" + finalPath + "/" + name;
        }
